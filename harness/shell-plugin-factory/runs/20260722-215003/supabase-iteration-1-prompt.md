Build the supabase shell plugin in this repository.
Use only the loaded author-shell-plugin skill as the shell-plugin recipe.
Only create or edit files under plugins/supabase/.
...
End with a concise summary of what you changed and any ambiguity or escalation reason.
